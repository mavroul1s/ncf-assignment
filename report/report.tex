...
\title{\textbf{Reproducing NeuMF on MovieLens-100K} \\[4pt]
       \large Deep Learning and its Applications --- Individual Assignment}
\author{%
  % TODO: replace the placeholders with your real info before submission.
  Nikolaos Mavroulakis \\
  AEM: XXXXX \\
  \texttt{mavroulakis@uth.gr}
}
\date{\today}
